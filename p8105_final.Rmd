...
us_sentiments = us_tweets %>%
  ...
  mutate(pos_sum = as.numeric(pos_sum),
         neg_sum = as.numeric(neg_sum),
         anger_sum = as.numeric(anger_sum,
         anticipation_sum = as.numeric(anticipation_sum),
         disgust_sum = as.numeric(disgust_sum),
         fear_sum = as.numeric(fear_sum),
         joy_sum = as.numeric(joy_sum),
         sadness_sum = as.numeric(sadness_sum),
         surprise_sum = as.numeric(surprise_sum),
         trust_sum = as.numeric(trust_sum)))
```
...
us_sentiments %>%
  select("state_name", "neg_sum") %>%
  rename(region = state_name, value = neg_sum) %>%
  state_choropleth()

us_sentiments %>%
  select("state_name", "pos_sum") %>%
  rename(region = state_name, value = pos_sum) %>%
  state_choropleth()
```
