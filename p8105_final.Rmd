...
A shiny repo for this analysis can be found: [here](https://github.com/k-maciejewski/p8105_final_shinyUS). The shiny app allows further interaction with the data.
...
A shiny repo [here for individual states](https://github.com/k-maciejewski/p8105_final_shiny_app)